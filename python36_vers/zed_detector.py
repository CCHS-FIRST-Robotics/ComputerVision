...
class ZEDDetector:
    ...
    def get_displacement(self, point: Tuple[int, int]):
    ...
    def get_tag_pose(self, tag: AprilTag) -> Union[Pose, None]:
    ...
    def get_camera_pose_pnp(self) -> Union[Pose, None]:
    ...
    def get_camera_pose_depth_average(self) -> Union[Pose, None]:
