...
class ZEDDetector:
    ...
    camera_to_robot_transformation = Pose(0.0, 0.0, -0.6, -0.44, 0.0, 0).get_transformation_matrix()
    ...
    def get_robot_pose(camera_pose: Pose) -> Pose:
        ...
        return Pose(disp[0], disp[1], disp[2] + .3, camera_pose.get_roll() + .46, camera_pose.get_pitch(), camera_pose.get_yaw())
    ...
    def tag_to_robot_pose(self, tag_pose):
        ...
        return Pose(disp[0], disp[1], disp[2] - .3, tag_pose.get_roll() + .46, tag_pose.get_pitch(), tag_pose.get_yaw())
